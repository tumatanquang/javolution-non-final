...
public final class TypeFormatTestSuite extends TestSuite {
	...
	class FormatInt extends TestCase {
		...
		public void validate() throws Exception {
			...
			TestContext.assertArrayEquals(_expected, _actual);
			TestContext.assertEquals("" + Integer.MIN_VALUE,
					TypeFormat.format(Integer.MIN_VALUE, TextBuilder.newInstance()).toString());
			TestContext.assertEquals("0", TypeFormat.format(0, TextBuilder.newInstance()).toString());
			TestContext.assertEquals("" + Integer.MAX_VALUE,
					TypeFormat.format(Integer.MAX_VALUE, TextBuilder.newInstance()).toString());
		}
	}
	...
	class FormatLong extends TestCase {
		...
		public void validate() throws Exception {
			...
			TestContext.assertArrayEquals(_expected, _actual);
			TestContext.assertEquals("" + Long.MIN_VALUE,
					TypeFormat.format(Long.MIN_VALUE, TextBuilder.newInstance()).toString());
			TestContext.assertEquals("0", TypeFormat.format(0L, TextBuilder.newInstance()).toString());
			TestContext.assertEquals("" + Long.MAX_VALUE,
					TypeFormat.format(Long.MAX_VALUE, TextBuilder.newInstance()).toString());
		}
	}
	...
	class FormatLongHexa extends FormatLong {
		...
		public void validate() throws Exception {
			...
			TestContext.assertArrayEquals(_expected, _actual);
			TestContext.assertEquals("-8000000000000000",
					TypeFormat.format(Long.MIN_VALUE, 16, TextBuilder.newInstance()).toString());
			TestContext.assertEquals("0", TypeFormat.format(0L, 16, TextBuilder.newInstance()).toString());
			TestContext.assertEquals("7fffffffffffffff",
					TypeFormat.format(Long.MAX_VALUE, 16, TextBuilder.newInstance()).toString());
		}
	}
	class StringBufferAppendLongHexa extends StringBufferAppendLong {
		...
		public void validate() {
			...
			TestContext.assertArrayEquals(_expected, _actual);
			TestContext.assertEquals("-8000000000000000",
					new StringBuffer().append(Long.toString(Long.MIN_VALUE, 16)).toString());
			TestContext.assertEquals("0", new StringBuffer().append(Long.toString(0, 16)).toString());
			TestContext.assertEquals("7fffffffffffffff",
					new StringBuffer().append(Long.toString(Long.MAX_VALUE, 16)).toString());
		}
	}
	class FormatDouble extends TestCase {
		...
		public void validate() throws Exception {
			...
			TestContext.assertArrayEquals(_expected, _actual, 0);
			TestContext.assertEquals("-Infinity",
					TypeFormat.format(Double.NEGATIVE_INFINITY, TextBuilder.newInstance()).toString());
			TestContext.assertEquals("0.0", TypeFormat.format(0.0, TextBuilder.newInstance()).toString());
			TestContext.assertEquals("Infinity",
					TypeFormat.format(Double.POSITIVE_INFINITY, TextBuilder.newInstance()).toString());
