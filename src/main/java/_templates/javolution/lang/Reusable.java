 ...
 *     <a href="//rtsj.dev.java.net/">RTSJ</a> VMs). For example:[code]
 ...
 * }[/code]</p>
 *
 * <p> Reusable objects can also be allocated from {@link _templates.javolution.context.ObjectFactory}
 *     in which case the {@link _templates.javolution.context.ObjectFactory#cleanup(java.lang.Object) cleanup}
