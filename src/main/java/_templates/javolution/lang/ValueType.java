 ...
 *     "stack" by executing within a {@link _templates.javolution.context.StackContext
 *     StackContext} and creating new instances with an  {@link
 *     _templates.javolution.context.ObjectFactory ObjectFactory}.
 *     It is the responsibility of the users to ensure
 *     that "stack" objects are {@link _templates.javolution.context.StackContext#outerCopy
 *     copied out} when
...
public interface ValueType extends Immutable {
	 ...
	 * and/or {@link _templates.javolution.context.AllocatorContext context} (Javolution)
