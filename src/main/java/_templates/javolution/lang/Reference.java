 ...
 *     references:<ul>
 *     <li> {@link _templates.javolution.context.PersistentContext.Reference PersistentContext.Reference} :
 *          Reachable accross multiple program executions.</li>
 *     <li> {@link _templates.javolution.context.LocalContext.Reference LocalContext.Reference} :
 *          Reachable only within the scope of the
 *          {@link _templates.javolution.context.LocalContext LocalContext}
 *          where it has been set.</li>
 *     <li> {@link _templates.javolution.context.AllocatorContext.Reference AllocatorContext.Reference} :
 *          Reachable only within the scope of the
 *          {@link _templates.javolution.context.AllocatorContext Allocator}
