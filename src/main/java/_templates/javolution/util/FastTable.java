...
public class FastTable/*<E>*/ extends FastCollection/*<E>*/ implements
	 ...
	 */
	private FastTable(Void unused, boolean rejectNulls) {
		...
		if(_size < size) {
			if(_rejectNulls)
				throw new NullPointerException(
						"Cannot expand with null padding when null values are rejected");
	...
	public void removeRange(int fromIndex, int toIndex) {
		if(fromIndex < 0 || toIndex < 0 || fromIndex > toIndex
				|| toIndex > _size)
			throw new IndexOutOfBoundsException(
					"FastTable removeRange(" + fromIndex + ", " + toIndex
							+ ") index out of bounds, size: " + _size);
	...
	private static final class SubTable/*<E>*/ extends FastCollection
		...
		public ListIterator/*<E>*/ listIterator(int index) {
			...
			throw new IndexOutOfBoundsException(
					"index: " + index + " for table of size: " + _size);
		}
		public List/*<E>*/ subList(int fromIndex, int toIndex) {
	...
	private static final class Unmodifiable/*<E>*/ extends FastTable
		...
		private Unmodifiable(FastTable/*<E>*/ table) {
			super((Void) null, table._rejectNulls);
			_table = table;
		}
		...
		public final boolean offerFirst(Object/*{E}*/ e) {
			throw new UnsupportedOperationException("Unmodifiable");
		}
		public final boolean offerLast(Object/*{E}*/ e) {
			throw new UnsupportedOperationException("Unmodifiable");
		}
		...
		public final boolean offer(Object/*{E}*/ e) {
			throw new UnsupportedOperationException("Unmodifiable");
		}
		...
		public final void push(Object/*{E}*/ e) {
			throw new UnsupportedOperationException("Unmodifiable");
		}
			...
			try {
				...
				for(;;) {
					try {
						w.acquire();
						try {
							return _table.removeLastOccurrence(o);
						}
						finally {
							w.release();
						}
