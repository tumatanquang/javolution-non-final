...
public class DefaultChannelCapacity {
	 ...
	 */
	public static final int INITIAL_DEFAULT_CAPACITY = 1 << 10;
	/**
	 * The current default capacity
	 */
	private static final SynchronizedInt DEFAULT_CAPACITY = new SynchronizedInt(
