...
public class SynchronousChannel implements BoundedChannel {
	...
	private final Queue waitingPuts = new Queue();
	private final Queue waitingTakes = new Queue();
	/**
	 * @return zero --
