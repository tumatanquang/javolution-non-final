...
public abstract class FJTask implements Runnable {
	 ...
	 * @throws ClassCastException if caller thread is not a
	 * running FJTask.
	 */
	 ...
	 * with respect to
	 * the group of worker threads.
	 * @throws ClassCastException if caller thread is not
	...
	public static class Seq2 extends FJTask {
		private final FJTask fst;
		private final FJTask snd;
