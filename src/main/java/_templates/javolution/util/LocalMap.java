...
public final class LocalMap/*<K,V>*/ implements Map/*<K,V>*/ {
	 ...
	 */
	private final LocalContext.Reference _mapRef = new LocalContext.Reference(
			new FastMap().shared());
	/**
	 * Default constructor.
	 */
	 ...
	 */
	public LocalMap /*<K,V>*/ setKeyComparator(
	 ...
	 * @return <code>this</code>
	 */
	public LocalMap/*<K,V>*/ setValueComparator(
	 ...
	 */
	public Object/*{V}*/ putDefault(Object/*{K}*/ key,
	 ...
	 */
	public void clear() {
		final FastMap localMap = localMap();
		for(FastMap.Entry e = localMap.head(), end = localMap
	 ...
	 */
	private final FastMap/*<K,V>*/ localMap() {
		final FastMap localMap = (FastMap) _mapRef.getLocal();
		return localMap != null ? localMap : newLocalMap();
	}
	private final FastMap newLocalMap() {
		final FastMap parentMap = (FastMap) _mapRef.get();
		final FastMap localMap = FastMap.newInstance();
		localMap.shared();
