	...
	*/
	...
	private static final class SubList/*<E>*/ extends FastCollection
		...
		public static SubList valueOf(FastList list, Node head, Node tail,
			...
			subList._tail = tail;
			subList._size = size;
			subList._parent = null;
			return subList;
		}
		private void incrementSize() {
			for(SubList subList = this; subList != null; subList = subList._parent) {
				++subList._size;
			}
		}
		...
		public final ListIterator/*<E>*/ listIterator(int index) {
			if(index < 0 || index > _size)
				throw new IndexOutOfBoundsException(
						"index: " + index + ", size: " + _size);
			final FastListIterator iterator = FastListIterator.valueOf(_list,
					nodeAt(index), index, _size);
			iterator._subList = this;
			return iterator;
		}
