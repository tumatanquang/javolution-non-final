...
import _templates.java.util.logging.Level;
import _templates.java.util.logging.LogRecord;
import _templates.java.util.logging.Logger;
...
public class StandardLog extends LogContext {
	...
	public static boolean isLoggable(Level level) {
		final LogContext log = LogContext.getCurrentLogContext();
	...
	public static void throwing(String sourceClass, String sourceMethod,
		...
		if(log instanceof StandardLog) {
			...
			LogContext.error(thrown,
					"Thrown by " + sourceClass + '.' + sourceMethod);
		}
	}
	/**
	...
	public void logError(Throwable error, CharSequence message) {
		...
		description = error != null ? error.toString() + ' ' + description
				: description;
