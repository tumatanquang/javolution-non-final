...
/**
 * <p> This class represents a high-performance, open-addressing hash set of <code>short</code>
 *     primitive values with linear probing.</p>
 *
 * <p> Unlike standard <code>java.util.HashSet&lt;Short&gt;</code> or <code>FastSet&lt;Short&gt;</code>
 *     which allocate wrapping objects and entry nodes for every single value, {@link FastShortSet}
 ...
 */
public class FastShortSet extends FastPrimitiveCollection
	...
	private transient short[] _table;
	...
	public boolean addAll(FastShortSet values) {
		if(values == null || values.size() == 0)
			return false;
		boolean modified = false;
		ensureCapacity(size + values.size());
		final FastShortIterator it = (FastShortIterator) values.iterator();
		while(it.hasNext()) {
			if(add(it.next())) {
				modified = true;
			}
	...
	public boolean containsAll(FastShortSet values) {
		if(values == null)
			return true;
		final FastShortIterator it = (FastShortIterator) values.iterator();
		while(it.hasNext()) {
	...
	public boolean removeAll(FastShortSet values) {
	...
	public boolean retainAll(FastShortSet values) {
	...
	public FastPrimitiveIterator/*FastShortIterator*/ iterator() {
		return new SetIterator(this);
	}
	public FastPrimitiveCollection/*FastShortSet*/ unmodifiable() {
		return new Unmodifiable(this);
	}
	public FastPrimitiveCollection/*FastShortSet*/ shared() {
		return new Shared(this);
	}
	public Object/*FastShortSet*/ clone() throws CloneNotSupportedException {
		/*@JVM-1.1+@
		if(true) {
			final FastShortSet c = (FastShortSet) super.clone();
			c._table = new short[_table.length];
	...
	public boolean equals(Object o) {
		if(this == o)
			return true;
		if(!(o instanceof FastShortSet))
			return false;
		final FastShortSet that = (FastShortSet) o;
		if(size() != that.size())
			return false;
	...
	private static final class SetIterator implements FastShortIterator {
		private final FastShortSet _set;
		private int _cursor = 0;
		private short _lastValue;
		private boolean _canRemove;
		private SetIterator(FastShortSet set) {
			_set = set;
			advance();
		}
		...
		public final short next() {
			...
			final short val = _set._table[_cursor++];
			_lastValue = val;
			_canRemove = true;
			advance();
			return val;
	...
	private static final class Unmodifiable extends FastShortSet
			implements Cloneable, Reusable, Serializable {
		private final FastShortSet _set;
		private Unmodifiable(FastShortSet set) {
			super(0);
			_set = set;
		}
		public final FastPrimitiveCollection/*FastShortSet*/ unmodifiable() {
			return this;
		}
		public final FastPrimitiveCollection/*FastShortSet*/ shared() {
		...
		public final Object/*FastShortSet*/ clone()
		...
		public final boolean remove(short value) {
			throw new UnsupportedOperationException("Unmodifiable");
		}
		public final boolean removeElement(short value) {
			throw new UnsupportedOperationException("Unmodifiable");
		}
		public final void clear() {
			throw new UnsupportedOperationException("Unmodifiable");
		}
		public final boolean addAll(short[] values) {
			throw new UnsupportedOperationException("Unmodifiable");
		}
		public final boolean addAll(FastShortSet values) {
			throw new UnsupportedOperationException("Unmodifiable");
		}
		public final boolean containsAll(short[] values) {
			return _set.containsAll(values);
		}
		public final boolean containsAll(FastShortSet values) {
			return _set.containsAll(values);
		}
		public final boolean removeAll(short[] values) {
			throw new UnsupportedOperationException("Unmodifiable");
		}
		public final boolean removeAll(FastShortSet values) {
			throw new UnsupportedOperationException("Unmodifiable");
		}
		public final boolean retainAll(FastShortSet values) {
			throw new UnsupportedOperationException("Unmodifiable");
		}
		...
		public final FastPrimitiveIterator/*FastShortIterator*/ iterator() {
			return new FastShortIterator() {
				private final FastShortIterator _it = (FastShortIterator) _set
						.iterator();
				public final boolean hasNext() {
					return _it.hasNext();
				}
	...
	private static final class Shared extends FastShortSet
			implements Cloneable, Reusable, Serializable {
		private final FastShortSet _set;
		private final ReadWriteLock _lock;
		private Shared(FastShortSet set) {
			super(0);
			_set = set;
		...
		public final FastPrimitiveIterator/*FastShortIterator*/ iterator() {
			final FastShortIterator iterator = (FastShortIterator) _set
					.iterator();
			return new FastShortIterator() {
				public final boolean hasNext() {
					boolean wasInterrupted = /*@JVM-1.1+@ true ? Thread.interrupted() : /**/false;
