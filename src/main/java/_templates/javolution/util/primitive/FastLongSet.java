...
/**
 * <p> This class represents a high-performance, open-addressing hash set of <code>long</code>
 *     primitive values with linear probing.</p>
 *
 * <p> Unlike standard <code>java.util.HashSet&lt;Long&gt;</code> or <code>FastSet&lt;Long&gt;</code>
 *     which allocate wrapping objects and entry nodes for every single value, {@link FastLongSet}
 ...
 */
public class FastLongSet extends FastPrimitiveCollection
	...
	public FastLongSet(int capacity) {
	...
	public boolean addAll(FastLongSet values) {
		if(values == null || values.size() == 0)
			return false;
		boolean modified = false;
		ensureCapacity(size + values.size());
		final FastLongIterator it = (FastLongIterator) values.iterator();
		while(it.hasNext()) {
			if(add(it.next())) {
				modified = true;
			}
	...
	public boolean containsAll(FastLongSet values) {
		if(values == null)
			return true;
		final FastLongIterator it = (FastLongIterator) values.iterator();
		while(it.hasNext()) {
	...
	public boolean removeAll(FastLongSet values) {
	...
	public boolean retainAll(FastLongSet values) {
	...
	public FastPrimitiveCollection/*FastLongSet*/ unmodifiable() {
		return new Unmodifiable(this);
	}
	public FastPrimitiveCollection/*FastLongSet*/ shared() {
		return new Shared(this);
	}
	public Object/*FastLongSet*/ clone() throws CloneNotSupportedException {
		/*@JVM-1.1+@
		if(true) {
			final FastLongSet c = (FastLongSet) super.clone();
			c._table = new long[_table.length];
	...
	public boolean equals(Object o) {
		if(this == o)
			return true;
		if(!(o instanceof FastLongSet))
			return false;
		final FastLongSet that = (FastLongSet) o;
		if(size() != that.size())
			return false;
	...
	private static final class SetIterator implements FastLongIterator {
		private final FastLongSet _set;
		private int _cursor = 0;
		private long _lastValue;
		private boolean _canRemove;
		private SetIterator(FastLongSet set) {
			_set = set;
			advance();
		}
		...
		public final long next() {
			...
			final long val = _set._table[_cursor++];
			_lastValue = val;
			_canRemove = true;
			advance();
			return val;
	...
	private static final class Unmodifiable extends FastLongSet
			implements Cloneable, Reusable, Serializable {
		private final FastLongSet _set;
		private Unmodifiable(FastLongSet set) {
			super(0);
			_set = set;
		}
		public final FastPrimitiveCollection/*FastLongSet*/ unmodifiable() {
			return this;
		}
		public final FastPrimitiveCollection/*FastLongSet*/ shared() {
		...
		public final Object/*FastLongSet*/ clone()
		...
		public final boolean addAll(FastLongSet values) {
			throw new UnsupportedOperationException("Unmodifiable");
		}
		public final boolean containsAll(long[] values) {
			return _set.containsAll(values);
		}
		public final boolean containsAll(FastLongSet values) {
			return _set.containsAll(values);
		}
		public final boolean removeAll(long[] values) {
			throw new UnsupportedOperationException("Unmodifiable");
		}
		public final boolean removeAll(FastLongSet values) {
			throw new UnsupportedOperationException("Unmodifiable");
		}
		public final boolean retainAll(FastLongSet values) {
			throw new UnsupportedOperationException("Unmodifiable");
		}
		...
		public final FastPrimitiveIterator/*FastLongIterator*/ iterator() {
			return new FastLongIterator() {
				private final FastLongIterator _it = (FastLongIterator) _set
						.iterator();
				public final boolean hasNext() {
					return _it.hasNext();
				}
	...
	private static final class Shared extends FastLongSet
			implements Cloneable, Reusable, Serializable {
		private final FastLongSet _set;
		private final ReadWriteLock _lock;
		private Shared(FastLongSet set) {
			super(0);
			_set = set;
		...
		public final FastPrimitiveIterator/*FastLongIterator*/ iterator() {
			final FastLongIterator iterator = (FastLongIterator) _set
					.iterator();
			return new FastLongIterator() {
				public final boolean hasNext() {
					boolean wasInterrupted = /*@JVM-1.1+@ true ? Thread.interrupted() : /**/false;
