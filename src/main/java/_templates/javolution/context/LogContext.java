...
public abstract class LogContext extends Context {
	 ...
	 */
	public static final Configurable/*<Class<? extends LogContext>>*/ DEFAULT = new Configurable(
			STANDARD) {
		protected void notifyChange(Object oldValue, Object newValue) {
			_Default = (LogContext) ObjectFactory.getInstance((Class) newValue)
					.object();
		}
	};
	/**
	...
	public static LogContext getCurrentLogContext() {
		for(Context ctx = Context.getCurrentContext(); ctx != null; ctx = ctx
				.getOuter()) {
	...
	public static boolean isDebugLogged() {
		return LogContext.getCurrentLogContext().isLogged("debug");
	}
	/**
	...
	public static void debug(CharSequence message) {
		LogContext.getCurrentLogContext().logDebug(message);
	}
	/**
	...
	public static void debug(Object message) {
		final LogContext logContext = LogContext.getCurrentLogContext();
	...
	public static boolean isInfoLogged() {
		return LogContext.getCurrentLogContext().isLogged("info");
	}
	/**
	...
	public static void info(CharSequence message) {
		LogContext.getCurrentLogContext().logInfo(message);
	}
	/**
	...
	public static boolean isWarningLogged() {
		return LogContext.getCurrentLogContext().isLogged("warning");
	}
	/**
	...
	public static void warning(CharSequence message) {
		LogContext.getCurrentLogContext().logWarning(message);
	}
	/**
	...
	public static boolean isErrorLogged() {
		return LogContext.getCurrentLogContext().isLogged("error");
	}
	/**
	...
	public static void error(Throwable error) {
		LogContext.getCurrentLogContext().logError(error, null);
	}
	/**
	...
	public static void error(Throwable error, CharSequence message) {
		LogContext.getCurrentLogContext().logError(error, message);
	}
	/**
	...
	public static void error(CharSequence message) {
		LogContext.getCurrentLogContext().logError(null, message);
	}
	/**
	 ...
	 */
	private static final class Console extends SystemOut {
		/*@JVM-1.6+@
