...
public abstract class AllocatorContext extends Context {
	 ...
	 * (javolution built-in tests {@link _templates.javolution.lang.Configurable#read
	 * loads} their configuration from systems properties)[code]
	 * > java -Djavolution.AllocatorContext.Default=javolution.context.PoolContext -jar javolution.jar time[/code]
	 */
	public static final Configurable/*<Class<? extends AllocatorContext>>*/ DEFAULT = new Configurable(
			HeapContext.class) {
		protected void notifyChange(Object oldValue, Object newValue) {
			_Default = (AllocatorContext) ObjectFactory
					.getInstance((Class) newValue).object();
		}
	};
	/**
	 * Default constructor.
	...
	/**
	 * <p> This class represents a {@link _templates.javolution.lang.Reference reference}
	...
	public static class Reference
			/*<T>*/ implements _templates.javolution.lang.Reference/*<T>*/ {
		/**
		 * Holds the factory.
		 */
	...
	private static class OuterContext extends AllocatorContext {
		...
		protected void enterAction() {
			...
			final Context outer = _outer.getOuter();
			if(outer == null) {
