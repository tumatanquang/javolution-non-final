 ...
 * };
 * ...
 * Vertex[] vertices = VERTICES_FACTORY.array(256);[/code]</p>
 *
...
public abstract class ArrayFactory/*<T>*/ {
	 ...
	 */
	public final Object/*{T}*/ array(int capacity) { // Short to be inlined.
	 ...
	 */
	public void recycle(Object/*{T}*/ array) { // Short to be inlined.
