 ...
 * }
 * writer.close(); // Writer is recycled, the underlying stream is closed.[/code]</p>
 *
...
public class XMLObjectWriter implements Reusable {
	...
	public static XMLObjectWriter newInstance(OutputStream out)
		...
		final XMLObjectWriter writer = (XMLObjectWriter) FACTORY.object();
	 ...
	 */
	public /*<T>*/ void write(Object/*{T}*/ obj, String localName, String uri,
