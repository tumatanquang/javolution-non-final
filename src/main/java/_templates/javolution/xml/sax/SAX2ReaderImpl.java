 ...
 * @see <a href="//www.saxproject.org"> SAX -- Simple API for XML</a>
 */
public final class SAX2ReaderImpl implements XMLReader, Reusable {
	...
	private static final class Proxy implements
		...
		public void startElement(CharArray namespaceURI, CharArray localName,
				CharArray qName, _templates.javolution.xml.sax.Attributes atts)
				throws SAXException {
			_attributes = atts;
		...
		public String getURI(int index) {
			final CharSequence chars = _attributes != null
					? _attributes.getURI(index)
					: null;
		...
		public String getLocalName(int index) {
			final CharSequence chars = _attributes != null
					? _attributes.getLocalName(index)
					: null;
			return chars != null ? chars.toString() : "";
		}
		// Implements Attributes
		...
		public int getIndex(String uri, String localName) {
			return uri != null && localName != null && _attributes != null
					? _attributes.getIndex(toCharSequence(uri),
							toCharSequence(localName))
					: -1;
		}
		// Implements Attributes
		public int getIndex(String qName) {
			return qName != null && _attributes != null
					? _attributes.getIndex(toCharSequence(qName))
					: -1;
		}
		// Implements Attributes
		public String getType(String uri, String localName) {
			return uri != null && localName != null && _attributes != null
					? _attributes.getType(toCharSequence(uri),
							toCharSequence(localName)).toString()
					: null;
		}
		// Implements Attributes
		public String getType(String qName) {
			return qName != null && _attributes != null
					? _attributes.getType(toCharSequence(qName)).toString()
					: null;
		}
		// Implements Attributes
		public String getValue(String uri, String localName) {
			return uri != null && localName != null && _attributes != null
					&& _attributes.getValue(toCharSequence(uri),
							toCharSequence(localName)) != null
									? _attributes
											.getValue(toCharSequence(uri),
													toCharSequence(localName))
											.toString()
									: null;
		}
		...
		public String getValue(String qName) {
			return qName != null && _attributes != null
					? _attributes.getValue(toCharSequence(qName)).toString()
					: null;
		}
	}
