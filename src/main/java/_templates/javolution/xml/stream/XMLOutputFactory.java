...
public abstract class XMLOutputFactory {
	 ...
	 */
	public static final Configurable/*<Class<? extends XMLOutputFactory>>*/ CLASS = new Configurable/*<Class<? extends XMLOutputFactory>>*/(
			Default.class) {};
	/**
	...
	*/
	...
	public static XMLOutputFactory newInstance() {
		final Class cls = (Class) CLASS.get();
	...
	private static final class Default extends XMLOutputFactory {
		...
		public XMLStreamWriter createXMLStreamWriter(Writer writer)
				throws XMLStreamException {
			final XMLStreamWriterImpl xmlWriter = newWriter();
		...
		private XMLStreamWriterImpl newWriter() {
			final XMLStreamWriterImpl xmlWriter = (XMLStreamWriterImpl) XML_WRITER_FACTORY
					.object();
			xmlWriter._objectFactory = XML_WRITER_FACTORY;
			xmlWriter.setRepairingNamespaces(
					_isRepairingNamespaces.booleanValue());
			...
			xmlWriter.setAutomaticEmptyElements(
					_automaticEmptyElements.booleanValue());
