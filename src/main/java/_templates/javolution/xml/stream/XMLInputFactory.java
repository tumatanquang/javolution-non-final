...
public abstract class XMLInputFactory {
	...
	CLASS = new Configurable/*<Class<? extends XMLInputFactory>>*/(
			Default.class) {};
	/**
	...
	private static final class Default extends XMLInputFactory {
		...
		public XMLStreamReader createXMLStreamReader(Reader reader)
				throws XMLStreamException {
			final XMLStreamReaderImpl xmlReader = newReader();
		...
		private XMLStreamReaderImpl newReader() {
			final XMLStreamReaderImpl xmlReader = (XMLStreamReaderImpl) XML_READER_FACTORY
					.object();
			if(_entities != null) {
