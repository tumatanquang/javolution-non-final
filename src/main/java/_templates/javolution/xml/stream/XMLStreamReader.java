...
public interface XMLStreamReader extends XMLStreamConstants {
	 ...
	 * href="//www.w3.org/TR/REC-xml-names/#ns-using">Namespaces in XML</a>
	 * specification to "http://www.w3.org/XML/1998/namespace".
	 *
	 * <p>
	 * <strong>NOTE:</strong> The 'xmlns' prefix must be resolved to following
	 * namespace <a href="//www.w3.org/2000/xmlns/">http://www.w3.org/2000/xmlns/</a>
	 *
	 ...
	 * final char[] myBuffer = new char[length];
	 * for(int sourceStart = 0; ; sourceStart += length) {
	 *     final int nCopied = stream.getTextCharacters( sourceStart, myBuffer, 0, length );
	 *     if(nCopied < length)
	 *         break;
	 * }[/code]
	 * XMLStreamException may be thrown if there are any XML errors in the underlying source.
	 * The "targetStart" argument must be greater than or equal to 0 and less than the length
	 * of "target", Length must be greater than 0 and "targetStart + length" must be less than
	 * or equal to length of "target".
	 *
