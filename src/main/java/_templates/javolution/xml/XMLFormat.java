...
public abstract class XMLFormat/*<T>*/ {
	 ...
	 */
	public static /*<T>*/ XMLFormat/*<T>*/ getInstance(
			Class/*<? extends T>*/ forClass) {
		final XMLFormat objectFormat = XMLBinding.OBJECT_XML; // Also forces initialization or XMLBinding.
		final XMLFormat xmlFormat = (XMLFormat) Reflection.getInstance()
				.getField(forClass, XMLFormat.class, true);
	...
	public String toString() {
		final Class boundClass = getBoundClass();
		return boundClass != null
				? "Default XMLFormat for " + boundClass.getName()
				: "Dynamic XMLtFormat (" + hashCode() + ")";
	}
	/**
	...
	public static final class InputElement {
		...
		public/*<T>*/ Object/*{T}*/ getNext() throws XMLStreamException {
			...
			final Object ref = readReference();
			if(ref != null)
				return (Object/*{T}*/) ref;
			// Retrieves object's class from element tag.
			final Class cls = _binding.readClass(_reader, false);
		...
		public/*<T>*/ Object/*{T}*/ get(String name) throws XMLStreamException {
			...
			final Class cls = _binding.readClass(_reader, true);
			return (Object/*{T}*/) readInstanceOf(cls);
		}
		/**
		 * Returns the object whose type is identified by a XML class attribute
		...
		private Object readReference() throws XMLStreamException {
			if(_referenceResolver == null)
				return null;
			final Object ref = _referenceResolver.readReference(this);
			if(ref == null)
				return null;
			if(_reader.next() != XMLStreamReader.END_ELEMENT)
		...
		private Object readInstanceOf(Class cls) throws XMLStreamException {
			// Retrieves format.
			final XMLFormat xmlFormat = _binding.getFormat(cls);
			// Creates object.
			_isReaderAtNext = false; // Makes attributes accessible.
			final Object obj = xmlFormat.newInstance(cls, this);
		...
		public CharArray getText() throws XMLStreamException {
			final CharArray txt = _reader.getElementText();
		...
		public String getAttribute(String name, String defaultValue)
				throws XMLStreamException {
			final CharArray value = getAttribute(name);
		...
		public/*<T>*/ Object/*{T}*/ getAttribute(String name,
			...
			final TextFormat format = TextFormat.getInstance(type);
	...
	public static final class OutputElement {
		...
		private final TextBuilder _tmpTextBuilder = new TextBuilder();
		/**
