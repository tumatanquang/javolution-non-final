...
public final class CharArray implements CharSequence, Comparable {
	...
	public final int indexOf(_templates.java.lang.CharSequence csq) {
		...
		final int end = _offset + _length - csqLength + 1;
	...
	public boolean equals(Object that) {
		...
		else if(that instanceof _templates.java.lang.CharSequence)
			return equals((_templates.java.lang.CharSequence) that);
		else
			return false;
	}
	// Do not make public or String instances may not use equals(String)
	private boolean equals(_templates.java.lang.CharSequence chars) {
		if(chars == null)
			return false;
	...
	public boolean equals(CharArray that) {
		...
		for(int i = that._offset + _length, j = _offset
				+ _length; --j >= _offset;) {
	...
	public CharSequence subSequence(int start, int end) {
		...
		final CharArray chars = new CharArray();
		chars._array = _array;
