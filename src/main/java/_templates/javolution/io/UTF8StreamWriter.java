...
public final class UTF8StreamWriter extends Writer implements Reusable {
	 ...
	 * For example:[code]
	 * Writer writer = new UTF8StreamWriter().setOutputStream(out);[/code]
	 * is equivalent but writes faster than [code]
	 * Writer writer = new java.io.OutputStreamWriter(out, "UTF-8");[/code]
	 *
	...
	public void write(char c) throws IOException {
		if(c < 0xd800 || c > 0xdfff) {
			...
			final int code = (_highSurrogate - 0xd800 << 10) + c - 0xdc00
					+ 0x10000;
			write(code);
		}
	}
