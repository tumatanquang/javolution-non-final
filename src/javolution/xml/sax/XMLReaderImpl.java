...
public class XMLReaderImpl implements XMLReader, Reusable {
	...
	private static final Reflection.Constructor NEW_URL = Reflection.getInstance()
			.getConstructor("java.net.URL(j2me.lang.String)");
	private static final Reflection.Method OPEN_STREAM = Reflection.getInstance()
			.getMethod("java.net.URL.openStream()");
	private static final Reflection.Constructor NEW_FILE_INPUT_STREAM = Reflection.getInstance()
	...
	private void parseAll() throws XMLStreamException, SAXException {
		...
		while(doContinue) {
			...
			case XMLStreamConstants.START_ELEMENT:
				...
				_contentHandler.startElement(uri, localName, qName, _xmlReader.getAttributes());
				break;
			...
			case XMLStreamConstants.SPACE:
				text = _xmlReader.getText();
				_contentHandler.ignorableWhitespace(text.array(), text.offset(), text.length());
				break;
