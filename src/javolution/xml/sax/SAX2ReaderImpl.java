...
public final class SAX2ReaderImpl implements XMLReader, Reusable {
	...
	public ContentHandler getContentHandler() {
		return _proxy._sax2Handler == DEFAULT_HANDLER ? null : _proxy._sax2Handler;
	}
	// Implements org.xml.sax.XMLReader interface.
	 ...
	 */
	private static final class Proxy implements javolution.xml.sax.ContentHandler, Attributes {
		/**
		...
		// Implements ContentHandler
		public void startElement(CharArray namespaceURI, CharArray localName, CharArray qName,
				javolution.xml.sax.Attributes atts) throws SAXException {
			_attributes = atts;
			_sax2Handler.startElement(namespaceURI.toString(), localName.toString(), qName.toString(), this);
		}
		// Implements ContentHandler
		...
		public int getIndex(String uri, String localName) {
			return uri != null && localName != null && _attributes != null
					? _attributes.getIndex(toCharSequence(uri), toCharSequence(localName))
					: -1;
		}
		// Implements Attributes
		...
		public String getType(String uri, String localName) {
			return uri != null && localName != null && _attributes != null
					? _attributes.getType(toCharSequence(uri), toCharSequence(localName)).toString()
					: null;
		}
		// Implements Attributes
		...
		public String getValue(String uri, String localName) {
			return uri != null && localName != null && _attributes != null
					&& _attributes.getValue(toCharSequence(uri), toCharSequence(localName)) != null
							? _attributes.getValue(toCharSequence(uri), toCharSequence(localName)).toString()
							: null;
		}
		// Implements Attributes
	...
	private static final class Sax2DefaultHandler implements EntityResolver, DTDHandler, ContentHandler, ErrorHandler {
