...
public final class Index extends Number implements Comparable<Index>, Record, Realtime, Immutable, XMLSerializable {
	 ...
	 */
	public static final Configurable<Integer> INITIAL_LAST = new Configurable(new Integer(_PositiveIndicesLength - 1)) {
		@Override
		protected void notifyChange(Object oldValue, Object newValue) {
	 ...
	 * immortal memory).
	 */
	private static final MemoryArea IMMORTAL_MEMORY = MemoryArea.getMemoryArea(new Object());
	/**
