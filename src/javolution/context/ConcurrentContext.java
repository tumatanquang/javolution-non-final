...
public abstract class ConcurrentContext extends Context {
	...
	private static int availableProcessors() {
		Reflection.Method availableProcessors = Reflection.getInstance()
	...
	public static void setConcurrency(int concurrency) {
		...
		concurrency = MathLib.min(MAXIMUM_CONCURRENCY.get().intValue(), concurrency);
	...
	static final class Default extends ConcurrentContext {
		 ...
		 */
		private static final ConcurrentThread[] _Executors = new ConcurrentThread[MAXIMUM_CONCURRENCY.get().intValue()];
		static {
