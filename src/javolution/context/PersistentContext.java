...
public class PersistentContext extends Context {
	...
	public static void setCurrentPersistentContext(PersistentContext ctx) {
		...
		synchronized(Reference.INSTANCES) {
			for(FastMap.Entry e = Reference.INSTANCES.head(), end = Reference.INSTANCES
	...
	protected void enterAction() {
		throw new java.lang.UnsupportedOperationException("Cannot enter persistent context (already in)");
	}
	/**
	 * Throws <code>UnsupportedOperationException</code> persistent context
	 * are global to all threads (singleton).
	...
	protected void exitAction() {
		throw new java.lang.UnsupportedOperationException("Cannot exit persistent context (always in)");
	}
	/**
